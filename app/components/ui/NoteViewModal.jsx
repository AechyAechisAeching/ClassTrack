...
export default function ViewModal({ visible, onClose, note }) {
  if (!note) return null;
      ...
      <View style={styles.modalOverlay}>
        <View style={styles.modalCard}>
          ...
          <View style={styles.statusContainer}>
            <View style={[
              styles.statusBadge,
              { backgroundColor: note.completed ? '#dcfce7' : '#fef3c7' }
            ]}>
              <Ionicons 
                name={note.completed ? "checkmark-circle" : "time-outline"} 
                size={16} 
                color={note.completed ? '#16a34a' : '#d97706'} 
              />
              <Text style={[
                styles.statusText,
                { color: note.completed ? '#16a34a' : '#d97706' }
